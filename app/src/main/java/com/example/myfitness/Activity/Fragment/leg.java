...
import com.example.myfitness.databinding.FragmentLegBinding;
...
public class leg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentLegBinding.inflate(getLayoutInflater(),container,false);




        database = FirebaseDatabase.getInstance();
        binding.legrv.setLayoutManager(new LinearLayoutManager(getContext()));
        categorylist = new ArrayList<>();
        absadapters = new categoryad(getContext(), categorylist);


        database.getReference().child("gymCategory").child("Legs").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.legrv.setAdapter(absadapters);
