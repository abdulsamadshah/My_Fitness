...
public class Abs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentAbsBinding.inflate(getLayoutInflater(),container,false);




        database = FirebaseDatabase.getInstance();
        binding.absrv.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        database.getReference().child("gymCategory").child("Abs").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.absrv.setAdapter(absadapters);
