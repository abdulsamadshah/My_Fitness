...
import com.example.myfitness.databinding.FragmentBackfBinding;
...
public class backf extends Fragment {

    FragmentBackfBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentBackfBinding.inflate(getLayoutInflater(),container,false);




        database = FirebaseDatabase.getInstance();
        binding.backrv.setLayoutManager(new LinearLayoutManager(getContext()));
        categorylist = new ArrayList<>();
        absadapters = new categoryad(getContext(), categorylist);


        database.getReference().child("gymCategory").child("Back").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.backrv.setAdapter(absadapters);
